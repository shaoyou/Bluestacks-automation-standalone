...
contextBridge.exposeInMainWorld("bsManager", {
  ...
  chestSummaryRange: (endDay: string, range: string, device?: string, userId?: string, startDay?: string) => ipcRenderer.invoke("chest:summary-range", endDay, range, device, userId, startDay),
  chestExportReport: (endDay: string, range: string, device?: string, userId?: string, startDay?: string) => ipcRenderer.invoke("chest:export-report", endDay, range, device, userId, startDay),
  ...
  chestCorrectEvent: (screenshotPath: string, corrections: Array<{ slot: number; itemName?: string | null; quantity: number | null }>, metadata?: { userId: string; sourceId: string; sourceName: string }) => ipcRenderer.invoke("chest:correct-event", screenshotPath, corrections, metadata),
